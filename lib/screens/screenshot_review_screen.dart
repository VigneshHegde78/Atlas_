                ...
                child: hasReal
                    ? GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final bool isAlreadyPermitted = memoryProvider
                          ...
                          return InkWell(
                            onTap: isAlreadyPermitted || _isSaving
                                ...
                                : () {
                                    setState(() {
                                      if (_selectedRealEntities.contains(
                                        entity,
                                      )) {
                                ...
                                if (isAlreadyPermitted)
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: AtlasColors.emerald.withOpacity(
                                          0.9,
                                        ),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed:
                      (_isSaving ||
                          (hasReal
                              ? _selectedRealEntities.isEmpty
                              : _selectedMockIds.isEmpty))
                      ? null
                      : () async {
                          setState(() {
                            _isSaving = true;
